...
Travus Helmly
wthelmly
Program that creates a client console in a bank
******************************************************/
...
public class TellerClient extends UnicastRemoteObject implements ActionListener, WindowListener,FocusListener,TellerClientChat, Serializable
{
public static void main(String[] args)
 {
	...
	if (args.length ==0) 
	   {
		System.out.println("Command line arguments as the server address and your name are missing.");
	   }
	if (args.length >2) 
	   {
	   System.out.println("More than two command line inputs provided.");
	   System.out.println("Only the first two are considered.");
	   }
	   try {
...
private JButton    previousChatButton     = new JButton ("Previous Message");
private JButton    nextChatButton         = new JButton ("Next Message");
private JButton    clearChatButton        = new JButton ("Hide Message");
...
//=========================================================
public TellerClient(String serverAddress, String tellerName) throws Exception // CONSTRUCTOR
	...
	sendChatTextField.addFocusListener(this);
	// show window
...
public void actionPerformed(ActionEvent ae)
	...
	try{
     ...
     if(ae.getSource()==sendChatButton)    sendChatToServer();
	}
	catch(Exception e)
	{
...
//========================================================
/*
The methods below (that have "window" in their names) have to be there if we are implementing
WindowListener interface. For this lab, we only develop what we need. But
we can't delete those that we don't develop
*/
...
//========================================================
/*
The methods below (that have "focus" in their names) have to be there if we are implementing
FocusListener interface. For this lab, we only develop what we need. But
we can't delete those that we don't develop
*/
public void focusGained(FocusEvent e) {
	
	sendChatTextField.setText(" ");
	sendChatTextField.setForeground(Color.BLACK);
}
